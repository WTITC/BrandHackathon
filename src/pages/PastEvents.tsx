...
const hackathonData = {
  sports: {
    ...
    events: [
      ...
      {
        name: "Athletic Innovation Challenge 2023",
        date: "August 2023",
        location: "Delhi, India",
        participants: 200,
        winners: ["Team RunSmart", "Team GameChanger", "Team SportVision"],
        highlights: [
        ...
        image:
          "https://images.unsplash.com/photo-1461896836934-gy58a908d6e0?w=600",
      },
    ],
  },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="space-y-12">
            {currentHackathon.events.map((event, index) => (
              ...
              >
                <div className="grid lg:grid-cols-2 h-[0px]"></div>
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        {event.highlights.map((highlight) => (
                          <li
                            key={highlight}
                            className="flex items-center gap-2 text-l text-muted-foreground"
                          >
